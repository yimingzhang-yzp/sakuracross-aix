...
export async function buildPayrollInput(period: PayrollPeriod) {
  ...
  return {
    ...
    staff: staff.map((s) => ({
      ...
      socialInsuranceEnrolled: s.socialInsuranceEnrolled,
      careInsuranceApplicable: s.careInsuranceApplicable,
      employmentInsuranceEnrolled: s.employmentInsuranceEnrolled,
      standardMonthlyRemuneration: s.standardMonthlyRemuneration,
      fixedIncomeTax: s.fixedIncomeTax,
    })),
      ...
      data: {
        ...
        items: {
          create: result.items.map((item) => ({
            ...
            careInsurance: item.careInsurance,
            pensionInsurance: item.pensionInsurance,
            employmentInsurance: item.employmentInsurance,
            incomeTax: item.incomeTax,
            standardMonthlyRemuneration: item.standardMonthlyRemuneration,
